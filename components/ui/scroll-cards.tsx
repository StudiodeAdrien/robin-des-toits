...
const CardText: FC<{
  ...
  return (
    <>
      ...
      {review && (
        <div className={`absolute bottom-32 md:bottom-40 px-8 md:px-16 ${
          ...
          <motion.div style={{ x: reviewX, opacity: reviewOpacity }}>
            <a
              ...
              className="pointer-events-auto block max-w-sm rounded-2xl border border-white/20 bg-white/10 px-6 py-5 backdrop-blur-sm transition-colors hover:bg-white/15"
            >
